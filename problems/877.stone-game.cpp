...
//         for (int l {2}; l <= n; ++++l) {
//             for (int i {0}; i <= n - l; ++i) {
//                 const int leftPile {piles[i]};
//                 const int rightPile {piles[i + l - 1]};

//                 currentRow[i] = max(
//                     prevRow[i + 1] + leftPile,
//                     prevRow[i] + rightPile
//                 );
//             }

//             swap(currentRow, prevRow);
//             fill(currentRow.begin(), currentRow.end(), -1);
//         }
...
//         const int aliceScore = prevRow[0];
...
//         for (int l {2}; l <= n; ++l) {
//             for (int i {0}; i <= n - l; ++i) {
//                 const bool isAliceTurn {l % 2 == 0};
//                 const int leftPile {isAliceTurn ? piles[i] : 0};
//                 const int rightPile {isAliceTurn ? piles[i + l - 1] : 0};

//                 dp[l][i] = max(dp[l - 1][i + 1] + leftPile, dp[l - 1][i] + rightPile);
//             }
//         }
